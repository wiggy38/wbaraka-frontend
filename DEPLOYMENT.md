...
|---|---|---|
| NEXT_PUBLIC_API_URL | https://api.baraka.bf/api/v1 | URL API Laravel |
| NEXT_PUBLIC_CDN_URL | https://cdn.baraka.bf | CDN Cloudflare R2 |

## Déploiement

1. Push sur `main` → déploiement automatique Vercel
2. Preview URL disponible sur chaque PR
3. Domaine custom : baraka.bf (à configurer dans Vercel DNS)
...
- [ ] Lighthouse mobile ≥ 85 sur baraka.bf
